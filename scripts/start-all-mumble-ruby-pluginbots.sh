...
# Bot 1
tmux new-session -d -n bot1 'ruby /home/botmaster/mumble-ruby-pluginbot/pluginbot.rb'

# Bot 2
tmux new-session -d -n bot2 'ruby /home/botmaster/mumble-ruby-pluginbot/pluginbot.rb'

# Bot 3
tmux new-session -d -n bot3 'ruby /home/botmaster/mumble-ruby-pluginbot/pluginbot.rb'
